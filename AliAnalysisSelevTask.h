#ifndef AliAnalysisSelevTask_H
#define AliAnalysisSelevTask_H
...
class AliAnalysisSelevTask : public AliAnalysisTaskSE
{
    public:
                                AliAnalysisSelevTask();
                                AliAnalysisSelevTask(const char *name, Bool_t bUseWeights, Bool_t buseEventSelector);

        virtual                 ~AliAnalysisSelevTask();
    ...
    private:
        AliAnalysisSelevTask(const AliAnalysisSelevTask&); // not implemented
        AliAnalysisSelevTask& operator=(const AliAnalysisSelevTask&); // not implemented
        ...
        Bool_t                  fUseEventSelector; // [kTrue]
        ...
        ClassDef(AliAnalysisSelevTask, 1);
};
